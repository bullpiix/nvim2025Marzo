...
vim.api.nvim_set_keymap("n", "<Space>f", ":lua _G.show_selection_window()<CR>", { noremap = true, silent = true })
...
local shortcuts = {
    ...
    { key = "md", action = "Escribe '='" },
    { key = "ms", action = "Escribe '.'" },
    { key = "ma", action = "Escribe ':'" },
    { key = "mq", action = "Escribe ','" },
    { key = "mw", action = "Escribe ';'" },
    { key = "me", action = "Escribe '_'" },
    { key = "mz", action = "Escribe '-'" },
    { key = "mx", action = "Escribe '/'" },
    { key = "mc", action = "Escribe '<'" },
    { key = "mf", action = "Escribe '>'" },
    { key = "iq", action = "Escribe '()'" },
    { key = "iw", action = "Escribe '{}'" },
    { key = "is", action = "Escribe '' " },
    { key = "id", action = "Escribe '+'" },
    { key = "iz", action = "Escribe '*'" },
    { key = "ix", action = "Escribe '!'" },
    { key = "ic", action = "Escribe '#'" },
    { key = "if", action = "Escribe '%'" },
}
