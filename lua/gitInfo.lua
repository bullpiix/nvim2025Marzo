...
function _G.show_menu()
  ...
  local str = result
    ...
    -- Mapear teclas
    vim.api.nvim_buf_set_keymap(buf_info_id, "n", "<Space>", ":lua _G.select_info_option()<CR>", { noremap = true, silent = true })
    vim.api.nvim_buf_set_keymap(buf_info_id, "n", "q", ":lua _G.close_menu_info()<CR>", { noremap = true, silent = true })
end
