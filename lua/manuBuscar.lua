...
vim.api.nvim_set_keymap("n", "tm", ":lua _G.input_buscador()<CR>" ,{ noremap = true, silent= true})
...
vim.api.nvim_set_keymap("n", "m", ":lua _G.auto_search_line()<CR>", { noremap = true, silent = true })
