...
vim.api.nvim_set_keymap('n', 'tg', ':tabnew<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'tu', ':Ex<CR>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', 'v', ':tabnext<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'e<Space>', 'dd', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('i',"<Tab><BackSpace>", '<Right><Esc>:lua CaptureIndent()<CR>i<CR><Esc>:lua ApplyIndent()<CR><Up>o', { noremap = true, silent = true })

vim.keymap.set("n", "ii", "viw", { noremap = true, silent = true })
vim.keymap.set("n", "<BackSpace>", ":call append(line('.'), repeat(' ', indent('.')))<CR>j", { noremap = true, silent = true })
vim.api.nvim_set_keymap('v',"<BackSpace>", '<Del>h', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('i','<Tab>t', '<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'tp', '<C-w>h', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'tl', '<C-w>l', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'to', 'ggVG', { noremap = true, silent = true })



-- Lista de letras mayúsculas (A-Z)
...
vim.api.nvim_set_keymap('n', 'tj', 'G', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'tk', 'gg', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'q', '<C-f>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'w', '<C-b>', { noremap = true, silent = true })
function my_grap()
...
vim.api.nvim_set_keymap('v', 'th', ':lua my_grap()<CR>', { noremap = true, silent = true })
