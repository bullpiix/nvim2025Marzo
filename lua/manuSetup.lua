...
vim.api.nvim_set_keymap('n', 'tv', ':tabnext<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'tl', 'ggVG', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'q', '<C-d>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'w', '<C-u>', { noremap = true, silent = true })
function my_grap()
