...
vim.keymap.set('n', '<Space>s', ':Neotree toggle<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '2', ':tabnew<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<Space>q', 'v', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<Space>w', 'V', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '1', ':tabnext<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n',"<BackSpace>", '$a<CR>', { noremap = true, silent = true })
