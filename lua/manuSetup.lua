...
vim.api.nvim_set_keymap('n', 'c', 'ggVG', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n','ñ', 'i', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i','ñ', '<Esc>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('i', '{d', "<CR><Up><Esc>o", { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '{{', "<Right>", { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '{ñ', "<Right><Right>", { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'i', "b", { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'u', "e", { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', 'i', "b", { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', 'u', "e", { noremap = true, silent = true })
