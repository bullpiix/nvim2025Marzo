...
vim.api.nvim_set_keymap('n', 'A', 'a""<Esc>i', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'S', 'a{}<Esc>i', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'D', 'a()<Esc>i', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'Q', "a''<Esc>i", { noremap = true, silent = true })
